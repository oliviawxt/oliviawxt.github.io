...
--
-- Host: localhost:3306
-- Generation Time: Mar 23, 2020 at 11:03 AM
...
INSERT INTO `shows` (`showsID`, `音乐剧名称`, `类型`, `poster`, `最新卡司`, `评价`) VALUES
(1, '《吉屋出租》', '正在演出', 'https://dl.airtable.com/.attachments/b22faa63fab939bbaf1e678d57f53057/6ee11788/O1CN01EOaEfW2GdSD0bi2qM_0-item_pic.jpg_q60.jpg', '郑艺彬 饰 Roger；夏振凯 饰 Mark；徐丽东 饰 Mimi', '”《吉屋出租》充满了力量与信念，像一团城市之火滚过舞台。“'),
...
(15, '《魔女宅急便》', '即将上演', NULL, '黄子弘凡', '不同立场、不同年龄层的人会有不一样的感受。'),
(18, '《第一次约会》', '即将上演', NULL, '高扬', '\"有趣，非常有趣！\"');
...
--
ALTER TABLE `shows`
  MODIFY `showsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
